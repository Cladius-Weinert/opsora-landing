...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${jetbrainsMono.variable} ${plusJakarta.variable} scroll-smooth`}>
      <head>
      ...
      <body className="min-h-screen bg-void-50 text-foreground antialiased">
        {children}
      </body>
    </html>
  );
